  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6" >
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseTitle"> Resources Title <sup className="text-pink-200">*</sup> </label>
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseShortDesc"> Resources Short Description <sup className="text-pink-200">*</sup>  </label>
      ...
      {/* Course Category */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseCategory"> Resources Category <sup className="text-pink-200">*</sup> </label>
  
        <select  {...register("courseCategory", { required: true })} defaultValue="" id="courseCategory" className="form-style w-full" >
          <option value="" disabled> Choose a Resources  </option>
          {!loading &&
        ...
        {errors.courseCategory && (<span className="ml-2 text-xs tracking-wide text-pink-200">  Resources Category is required </span>)}
      </div>
      ...
      <Upload name="courseImage" label="Resources Thumbnail" register={register} setValue={setValue} errors={errors}  editData={editCourse ? course?.thumbnail : null} />
     
      {/* Benefits of the course */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseBenefits">
          Benefits of this Resources <sup className="text-pink-200">*</sup>
        </label>
