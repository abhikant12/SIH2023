  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6" >
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseTitle"> Respository Title <sup className="text-pink-200">*</sup> </label>
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseShortDesc"> Respository Short Description <sup className="text-pink-200">*</sup>  </label>
      ...
      {/* Course Category */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseCategory"> Respository Category <sup className="text-pink-200">*</sup> </label>
      ...
      <Upload name="courseImage" label="Respository Thumbnail" register={register} setValue={setValue} errors={errors}  editData={editCourse ? course?.thumbnail : null} />
     
      {/* Benefits of the course */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseBenefits">
          Benefits of the Respository <sup className="text-pink-200">*</sup>
        </label>
